...
The raw dataset contained cancelled orders, transactions without customer identifiers, and a small number of records with invalid quantity or price values. To ensure the analysis and reporting reflected genuine customer purchasing activity, these records were excluded from the final dataset.
